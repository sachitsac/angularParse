...
make test
```
This will start the testing using karma, jasmine. If you wish to enable continuous watching, then in karma config file, change

```
singleRun: true to singleRun: false.
```
